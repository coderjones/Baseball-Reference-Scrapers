...
# Comments: I only changed tbl_df() to as_tibble() to remove depricated function.
# Otherwise, I've just played around with different years and such.
